...
\begin{deluxetable}{lrrrr}[htb!]
	...
	\tablewidth{0pt}
	\tablehead{
		\colhead{set} & \colhead{$h_x$} & \colhead{$h_y$} & \colhead{$h_z$} & \colhead{$|h|$}  
	}
	\startdata
		total &   8.21 &  0.35 &  -9.77 &  12.77 \\
		MW disk &   4.18 & -0.82 &  -4.82 &   6.43 \\
		M31 disk &   3.35 & -1.34 &  -5.14 &   6.28 \\
		MW bulge &   4.22 & -0.31 &  -5.32 &   6.80 \\
		M31 bulge &   3.78 & -0.76 &  -4.88 &   6.22 \\
		MW halo &  11.23 &  1.58 & -12.51 &  16.89 \\
		M31 halo &   5.64 & -0.74 &  -7.51 &   9.42 \\
	\enddata
\end{deluxetable}
