...
%	\item Apply some of the techniques used on the remnant to the precursor galaxies. For example
%		\begin{itemize}
%			\setlength\itemsep{-1mm}
%			\item Rotation curves, $V_{rot}/\sigma$ plots.
%			\item How do the bulge/halo rotations vary with radius?
%		\end{itemize}	
%	\item Changes in mass profile during merger.	
%	\item Does stellar density profile agree with predictions for elliptical galaxies?	
%	\item Does the virial theorem work to return the total baryonic mass?
%\end{itemize}
