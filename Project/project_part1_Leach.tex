...
For oblate isotropic rotators, there is a widely-cited relationship between $v_{\text{max}} / \sigma_c$ and ellipticity $\epsilon$ \citep{binney_rotation_1978}: $(V/\sigma) = \sqrt{\epsilon / (1 - \epsilon)}$.
