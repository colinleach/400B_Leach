...
\todo{\textbf{Velocity dispersion of the stellar remnant as a function of radius}}

\todo{\textbf{Does the virial theorem work to return the total baryonic mass?}}

\todo{fix section on phase diagrams}

Baryonic particles in the merger remnant have a small net angular momentum, and we can rotate the coordinate system to align this vector with the $z$-axis. However, the phase diagrams in Figure \ref{fig:rem_phase} show that velocities are mostly randomly distributed and few of the particles show much asymmetry.
...
idx, nearest = find\_nearest(rho.value, 200*rho\_lim.value)
r\_200 = r\_annuli[idx]
r\_200, nearestotal energy $E$ is the sum of kinetic energy $K$ and potential energy $W$. We have the mass and velocity of every particle so 
...
\todo{Calculate at least final values, preferably a timecourse}
