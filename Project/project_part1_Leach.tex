...
\todo{Does stellar density profile agree with predictions for elliptical galaxies?}

\todo{Does the virial theorem work to return the total baryonic mass?}
