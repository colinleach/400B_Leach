...
The mass profile for each type of particle and overall is shown in Table \ref{fig:rem_mp_type}. This is similar to Figure \ref{fig:massprof0}, except that the radius now extends out to 100 kpc.
...
\begin{figure}[htb!]
	...
	\caption{Spherically-averaged density profiles of the remnant halo by origin.
...
This was carried out for all the particles in the merger remnant and various subsets, as show in Table \ref{tbl:remn_h}
