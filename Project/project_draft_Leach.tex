...
The eigenvalues give the relative dimensions, in arbitrary units scaled such that $a=1$:
\[ a=1.0, b= 0.85, c=0.79 \]
The luminous ellipsoid is thus triaxial (low symmetry) but not grossly divergent from spherical.
